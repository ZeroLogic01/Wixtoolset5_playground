...
namespace InstallerUI.Bootstrapper
{
    ...
    public class WixBA : BootstrapperApplication
    {
        ...
        protected override void Run()
        {
            ...
            WixBA.View = Container.GetExportedValue<MainView>(ContractNames._MainView);
        ...
        private void SetupCompositionContainer()
        {
            ...
            //Container.ComposeExportedValue<IInteractionService>();
            //Container.ComposeExportedValue<ITaskBar>();
            //Container.ComposeExportedValue<INavigationService>();
